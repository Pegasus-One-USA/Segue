...
#   ./build-images.sh -r myregistry.azurecr.io -t v1.2.0 -p   # build+push all 4, ACR
#   ./build-images.sh -r 123456789012.dkr.ecr.us-east-1.amazonaws.com/fhirbridge -t v1.2.0 -p  # ECR, all 4
#
