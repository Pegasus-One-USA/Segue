...
export class NodeLibraryDialogComponent {
  ...
  // Uses destTypeLabel() rather than a literal sql/csv check so it stays correct now that destWizardType
  // spans all five destination kinds (sql/csv/mysql/mongo/postgres), not just the original two.
