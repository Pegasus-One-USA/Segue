...
/**
 * MySQL variant of the destination card — one per resource's table, plus one row per existing
 ...
 */
@Component({
  selector: 'app-field-mapping-target-card-mysql',
  standalone: true,
  imports: [],
  templateUrl: './field-mapping-target-card-mysql.component.html',
  styleUrl: './field-mapping-target-card-mysql.component.scss',
})
export class FieldMappingTargetCardMySqlComponent implements AfterViewInit, OnDestroy {
