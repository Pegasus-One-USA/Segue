...
/**
 * SQL Server variant of the destination card — one per resource's table, plus one row per existing
 ...
 */
@Component({
  selector: 'app-field-mapping-target-card-sql-server',
  standalone: true,
  imports: [],
  templateUrl: './field-mapping-target-card-sql-server.component.html',
  styleUrl: './field-mapping-target-card-sql-server.component.scss',
})
export class FieldMappingTargetCardSqlServerComponent implements AfterViewInit, OnDestroy {
