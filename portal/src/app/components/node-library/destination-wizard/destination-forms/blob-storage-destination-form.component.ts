...
/** Minimal stand-in form for the BlobStorage destination type — see SimpleStubFormEngine. */
@Component({
...
export class BlobStorageDestinationFormComponent implements WizardDestinationFormApi {
  private readonly engine = new SimpleStubFormEngine(inject(FormBuilder), 'Azure Blob Storage Destination', [
    { key: 'container', label: 'Container name', placeholder: 'e.g. fhirbridge-exports' },
  ]);
