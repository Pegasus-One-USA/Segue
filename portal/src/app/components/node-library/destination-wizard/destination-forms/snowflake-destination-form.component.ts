...
/** Minimal stand-in form for the Snowflake destination type — see SimpleStubFormEngine. */
@Component({
  selector: 'app-snowflake-destination-form',
  standalone: true,
  imports: [ReactiveFormsModule],
  templateUrl: './simple-stub-destination-form.component.html',
})
export class SnowflakeDestinationFormComponent implements WizardDestinationFormApi {
  private readonly engine = new SimpleStubFormEngine(inject(FormBuilder), 'Snowflake Destination', [
