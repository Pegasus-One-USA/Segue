import { SourceFormRegistry } from '../shared-v2/config-form/config-form-v2.contract';
 ...
 *  end-to-end via WizardServiceV2 (audience config, discovery, JWT key management, existing-connection cloning, ...)
 ...
 *  SourceConfigFormComponent.getFields() and has no WizardServiceV2/entity-mode integration at all. Shared by
