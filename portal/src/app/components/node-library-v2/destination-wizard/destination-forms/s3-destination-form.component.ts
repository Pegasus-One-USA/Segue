...
/** Minimal stand-in form for the S3 destination type — see SimpleStubFormEngine. */
@Component({
  selector: 'app-s3-destination-form',
  standalone: true,
  imports: [ReactiveFormsModule],
  templateUrl: './simple-stub-destination-form.component.html',
})
export class S3DestinationFormComponent implements WizardDestinationFormApi {
  private readonly engine = new SimpleStubFormEngine(inject(FormBuilder), 'Amazon S3 Destination', [
