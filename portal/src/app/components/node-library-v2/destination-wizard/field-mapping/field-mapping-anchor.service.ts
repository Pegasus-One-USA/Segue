 ...
 * CanvasServiceV2, but scoped per mapping-canvas instance rather than a root singleton, and with an
...
export class FieldMappingAnchorService {
   ...
   * workflow canvas's CanvasServiceV2, which doesn't anchor button-triggered zoom either).
   */
