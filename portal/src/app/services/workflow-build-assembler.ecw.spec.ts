 ...
 * canvas workflow's SourceConnection — WizardService.save() deliberately doesn't call the backend in canvas mode —
 ...
 */
describe('WorkflowBuildAssemblerService — eCW source assembly', () => {
