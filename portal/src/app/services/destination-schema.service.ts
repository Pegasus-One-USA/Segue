...
export interface DestinationColumn {
  ...
  // Total significant digits / digits right of the decimal point for a numeric/decimal column — null for
  // non-numeric types and for types (float/real/money) the driver doesn't report either for.
