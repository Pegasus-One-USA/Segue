...
import { PagedResult, SchedulerHistoryEntry } from '../../models/operations.model';
...
export class SchedulerHistoryComponent implements OnInit {
  ...
  load(): void {
    ...
    this.api.schedulerHistory(this.correlationId() || undefined, this.pageIndex() + 1, this.pageSize()).subscribe({
