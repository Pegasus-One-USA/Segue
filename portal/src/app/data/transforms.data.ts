...
export const TRANSFORMS: Transform[] = [
  ...
  { id: 'dest-sqlserver',   rank: 7, category: 'Relational',   name: 'SQL Server',         sub: 'Write to Microsoft SQL Server.',    permissionPrefix: 'sqlserver' },
  { id: 'dest-azuresql',    rank: 7, category: 'Relational',   name: 'Azure SQL',          sub: 'Write to Azure SQL Database.',      permissionPrefix: 'azuresql' },
  { id: 'dest-postgres',    rank: 7, category: 'Relational',   name: 'PostgreSQL',         sub: 'Write to PostgreSQL.',              permissionPrefix: 'postgresql' },
  { id: 'dest-mysql',       rank: 7, category: 'Relational',   name: 'MySQL',              sub: 'Write to MySQL.',                   permissionPrefix: 'mysql' },
  { id: 'dest-mongo',       rank: 7, category: 'NoSQL',        name: 'MongoDB',            sub: 'Write to a MongoDB collection.',    permissionPrefix: 'mongo' },
  ...
  { id: 'dest-snowflake',   rank: 7, category: 'Analytics',    name: 'Snowflake',          sub: 'Load into Snowflake.',              permissionPrefix: 'sourceconnections' },
  { id: 'dest-powerbi',     rank: 7, category: 'Analytics',    name: 'Power BI',           sub: 'Push to a Power BI dataset.',       permissionPrefix: 'sourceconnections' },
  { id: 'dest-tableau',     rank: 7, category: 'Analytics',    name: 'Tableau',            sub: 'Publish to Tableau.',               permissionPrefix: 'sourceconnections' },
  { id: 'dest-databricks',  rank: 7, category: 'Analytics',    name: 'Databricks',         sub: 'Load into Databricks.',             permissionPrefix: 'sourceconnections' },
  { id: 'dest-blob',        rank: 7, category: 'Cloud / FHIR', name: 'Azure Blob Storage', sub: 'Write objects to Azure Blob.',      permissionPrefix: 'blobstorage' },
  { id: 'dest-s3',          rank: 7, category: 'Cloud / FHIR', name: 'Amazon S3',          sub: 'Write objects to Amazon S3.',       permissionPrefix: 'sourceconnections' },
  { id: 'dest-fhir',        rank: 7, category: 'Cloud / FHIR', name: 'FHIR Repository',    sub: 'POST a transaction bundle to a FHIR store.', permissionPrefix: 'sourceconnections' },
  ...
  { id: 'dest-parquet',     rank: 7, category: 'File',         name: 'Parquet',            sub: 'Emit columnar Parquet.',            permissionPrefix: 'sourceconnections' },
  { id: 'dest-avro',        rank: 7, category: 'File',         name: 'Avro',               sub: 'Emit Avro records.',                permissionPrefix: 'sourceconnections' },
  { id: 'dest-protobuf',    rank: 7, category: 'File',         name: 'Protobuf',           sub: 'Emit Protobuf messages.',           permissionPrefix: 'sourceconnections' },
  { id: 'dest-pdf',         rank: 7, category: 'File',         name: 'PDF Report',         sub: 'Render a PDF report.',              permissionPrefix: 'sourceconnections' },
  { id: 'dest-sftp',        rank: 7, category: 'Delivery',     name: 'SFTP',               sub: 'Deliver files over SFTP.',          permissionPrefix: 'sftp' },
  { id: 'dest-restapi',     rank: 7, category: 'Delivery',     name: 'REST API',           sub: 'POST to an outbound REST endpoint.', permissionPrefix: 'sourceconnections' },
  { id: 'dest-inmemory',    rank: 7, category: 'Delivery',     name: 'In-memory (test)',   sub: 'Sink for testing — discards output.', permissionPrefix: 'sourceconnections' },
