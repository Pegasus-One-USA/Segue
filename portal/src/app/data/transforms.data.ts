...
export const TRANSFORMS: Transform[] = [
  ...
  { id: 'dest-fhir',        rank: 7, category: 'Cloud / FHIR', destinationType: 'FhirRepository', name: 'Aidbox',             sub: 'POST a transaction bundle to a FHIR store.', permissionPrefix: 'fhirrepository' },
  { id: 'dest-medplum',     rank: 7, category: 'Cloud / FHIR', destinationType: 'Medplum',        name: 'Medplum (FHIR)',     sub: 'Write FHIR resources to a Medplum store', permissionPrefix: 'medplum' },
  { id: 'dest-azurefhir',   rank: 7, category: 'Cloud / FHIR', destinationType: 'AzureFhirService', name: 'Azure FHIR Service', sub: 'Write FHIR resources to Azure Health Data Services.', permissionPrefix: 'azurefhirservice' },
