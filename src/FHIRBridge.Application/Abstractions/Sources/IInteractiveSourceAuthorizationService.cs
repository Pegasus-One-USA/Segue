...
/// is never stranded on this endpoint's bare JSON response. All three are false/null when no workflow run was
/// triggered at all (a plain sign-in) or no redirect URI is configured.
/// </summary>
