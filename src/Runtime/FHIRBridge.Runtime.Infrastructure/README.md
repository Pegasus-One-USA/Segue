...
## Responsibilities
- Acquire EHR access tokens across the grant types FHIRBridge supports and select the right one per source, caching tokens in a distributed cache with an expiry skew.
