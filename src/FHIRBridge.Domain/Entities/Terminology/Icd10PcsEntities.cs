...
/// <summary>One ICD-10-PCS procedure code, sourced from CMS's annual/mid-year code-table release.</summary>
public sealed class Icd10PcsCode
{
    private Icd10PcsCode() { }

    public Icd10PcsCode(string code, string shortDescription, string longDescription, bool isActive, string version)
    {
        Code = code.Trim();
...
public sealed class Icd10PcsVersion
{
    private Icd10PcsVersion() { }
    ...
    public Icd10PcsVersion(string version, DateTime? releaseDateUtc, string? checksumSha256, bool isActive)
    {
...
public sealed class Icd10PcsImportHistory
{
    private Icd10PcsImportHistory() { }
    public Guid Id { get; private set; } = Guid.NewGuid();
    ...
    public Icd10PcsImportHistory(string? version, string? checksumSha256)
    {
