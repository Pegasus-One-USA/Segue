...
/// <summary>One CVX (vaccine administered) code, sourced from the CDC's flat-file/XML code-set export.</summary>
public sealed class CvxCode
{
    private CvxCode() { }

    public CvxCode(string code, string shortDescription, string fullVaccineName, bool isActive, string version)
    {
        Code = code.Trim();
        ShortDescription = shortDescription.Trim();
        FullVaccineName = fullVaccineName.Trim();
        IsActive = isActive;
    ...
    public string FullVaccineName { get; private set; } = default!;
    public bool IsActive { get; private set; }
    public string Version { get; private set; } = default!;
    public DateTime CreatedOnUtc { get; private set; }
    public DateTime ModifiedOnUtc { get; private set; }

    public void Update(string shortDescription, string fullVaccineName, string version, bool isActive)
    {
        ShortDescription = shortDescription.Trim();
        FullVaccineName = fullVaccineName.Trim();
        Version = version.Trim();
...
public sealed class CvxVersion
{
    private CvxVersion() { }
    ...
    public CvxVersion(string version, DateTime? releaseDateUtc, string? checksumSha256, bool isActive)
    {
...
public sealed class CvxImportHistory
{
    private CvxImportHistory() { }
    public Guid Id { get; private set; } = Guid.NewGuid();
    ...
    public CvxImportHistory(string? version, string? checksumSha256)
    {
